...
class Transport extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<Transport> createState() => _TransportState();
}

final transportProvider = StateProvider<double>((ref) => 0.0);
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 20,),
              Image.asset("Assets/Images/category/transport.jpg"),
              SizedBox(height: 20,),
              Column(
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () async {
                      ...
                      if (user != null) {
                        final category = 'transport'; // Replace with the actual category
                        final ratingData = {
                          'rating': (userRating / 5.0 * 100).toStringAsFixed(0),
