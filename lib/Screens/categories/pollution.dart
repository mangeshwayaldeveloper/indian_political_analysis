...
class Pollution extends ConsumerStatefulWidget {
  const Pollution({super.key});

  @override
  ConsumerState<Pollution> createState() => _PollutionState();
}

final pollutionProvider = StateProvider<double>((ref) => 0.0);

class _PollutionState extends ConsumerState<Pollution> {
        ...
        child: Column(children: [
          Column(
            ...
            children: [
              ...
              SizedBox(height: 20,),
              Image.asset("Assets/Images/category/pollution.jpg"),
              SizedBox(height: 20,),
              Column(
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () async {
                      ...
                      if (user != null) {
                        final category = 'pollution'; // Replace with the actual category
                        final ratingData = {
                          'rating': (userRating / 5.0 * 100).toStringAsFixed(0),
