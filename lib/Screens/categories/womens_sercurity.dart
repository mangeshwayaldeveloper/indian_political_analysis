...
class WomensSecurity extends ConsumerStatefulWidget {
  const WomensSecurity({super.key});

  @override
  ConsumerState<WomensSecurity> createState() => _WomensSecurityState();
}

final womenssecProvider = StateProvider<double>((ref) => 0.0);

class _WomensSecurityState extends ConsumerState<WomensSecurity> {
        ...
        child: Column(children: [
          Column(
            ...
            children: [
              ...
              SizedBox(height: 20,),
              Image.asset("Assets/Images/category/womensSec.jpg"),
              SizedBox(height: 20,),
              Column(
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () async {
                      ...
                      if (user != null) {
                        final category = 'womensSecurity'; // Replace with the actual category
                        final ratingData = {
                          'rating': (userRating / 5.0 * 100).toStringAsFixed(0),
