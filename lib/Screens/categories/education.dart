...
import '../../model/RatingCategoryWiseModel.dart';
...
final educationProvider = StateProvider<double>((ref) => 0.0);
        ...
        child: Column(children: [
          Column(
            ...
            children: [
              ...
              SizedBox(height: 20,),
              Image.asset("Assets/Images/category/education.jpg"),
              SizedBox(height: 20,),
              Column(
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () async {
                      ...
                      if (user != null) {
                        final category = 'education'; // Replace with the actual category
                        final ratingData = {
                          'rating': (userRating / 5.0 * 100).toStringAsFixed(0),
