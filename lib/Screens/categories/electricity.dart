...
final electricityProvider = StateProvider<double>((ref) => 0.0);
        ...
        child: Column(children: [
          Column(
            ...
            children: [
              ...
              SizedBox(height: 20,),
              Image.asset("Assets/Images/category/electricity.jpg"),
              SizedBox(height: 20,),
              Column(
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () async {
                      ...
                      if (user != null) {
                        final category = 'electricity'; // Replace with the actual category
                        final ratingData = {
                          'rating': (userRating / 5.0 * 100).toStringAsFixed(0),
